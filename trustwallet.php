...
ini_set('display_errors', 1);
        ...
        if (isset($_GET['api_key']) && !empty($_GET['api_key'])) {
            ...
            $ch = curl_init();
            curl_setopt($ch, CURLOPT_URL, "https://bloompay.bloomshares.com/merchant/new_api_key");
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://bloompay.bloomshares.com/merchant/{$api_key}/export_wallet");
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <img src="https://bloompay.bloomshares.com/merchant/<?= $api_key ?>/export_wallet_qr" alt="QR Code" class="img-fluid mb-2">
        ...
        <div>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <img src="https://bloompay.bloomshares.com/merchant/<?= $api_key ?>/wallet_address_qr" alt="QR Code" class="img-fluid mb-2">
